...
# Buscar archivos que contengan AccountKey
git log --all --grep="AccountKey" --oneline | head -10

echo ""
echo "🧹 Removiendo credenciales del historial de Git..."

# Remover del historial todos los archivos que contengan las credenciales
...
# Limpiar las referencias y el directorio de backup
